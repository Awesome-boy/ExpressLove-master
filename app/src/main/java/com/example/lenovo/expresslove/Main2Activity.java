  ...
  private WebView webView;
            ...
            public void onClick(View view) {
                ...
                b.setPositiveButton("Next", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        c.setTitle("♡ Alice");
                        c.setMessage("七岁的那一年 抓住那只蝉 希望能抓住一个夏天");
                        c.setPositiveButton("Next", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                AlertDialog.Builder d = new AlertDialog.Builder(Main2Activity.this);
                                d.setTitle("♡ Alice");
                                d.setMessage("二十七岁的这一年 握住你的手 携手到永远");
                                d.setNegativeButton("Next", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        AlertDialog.Builder y = new AlertDialog.Builder(Main2Activity.this);
                                        y.setTitle("♡ Alice");
                                        y.setMessage("爱你三千遍");
                                        y.setNegativeButton("Next", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialogInterface, int i) {
                                                Intent intent=new Intent(Main2Activity.this,BannerActivity.class);
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        if(keyCode == KeyEvent.KEYCODE_BACK){
            new CommomDialog(this, R.style.dialog, "岁月很长 未来可期!", new CommomDialog.OnCloseListener() {
                @Override
